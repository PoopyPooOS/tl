...
impl Location {
    pub fn new(path: impl Into<PathBuf>, lines: RangeInclusive<usize>) -> Self {
        Self {
            path: path.into(),
            lines,
            section: None,
    ...
    pub fn new_with_section(path: impl Into<PathBuf>, lines: RangeInclusive<usize>, section: RangeInclusive<usize>) -> Self {
